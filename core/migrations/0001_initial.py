    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_limits', models.CharField(choices=[('ALL', 'ALL'), ('KIDS', 'KIDS')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_limits', models.CharField(blank=True, choices=[('ALL', 'ALL'), ('KIDS', 'KIDS')], max_length=5, null=True)),
                ('image', models.ImageField(blank=True, null=True, upload_to='images')),
                ('videos', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.video')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
